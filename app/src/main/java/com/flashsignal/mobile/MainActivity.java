...
public class MainActivity extends Activity {
    ...
    private final class MobileBridge {
        ...
        @JavascriptInterface
        public void setAllMatchesMode(boolean enabled) {
            runOnUiThread(() -> sendCommand(MonitorService.ACTION_SET_ALL, true, enabled));
        }

        @JavascriptInterface
        public void setTrackingEnabled(boolean enabled) {
            runOnUiThread(() -> sendCommand(MonitorService.ACTION_SET_ENABLED, true, enabled));
        }

        @JavascriptInterface
        public void scanNow() {
            runOnUiThread(() -> sendCommand(MonitorService.ACTION_SCAN_NOW, false, false));
        }
